...
import { BarChart3, Camera, Leaf, ShoppingCart, Heart, TrendingUp, AlertTriangle, CheckCircle, DollarSign, User, Mail, Phone, MapPin } from "lucide-react"
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-white rounded-lg border border-emerald-200">
                ...
                <div className="text-xs text-emerald-600 mt-1">+{Math.floor(Math.random() * 20 + 10)}% from yesterday</div>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border border-emerald-200">
                <div className="text-2xl font-bold text-green-700">{Math.round((stats.cropsMonitored - stats.diseaseDetections) / Math.max(stats.cropsMonitored, 1) * 100)}%</div>
                <div className="text-sm text-gray-600">Healthy Crops</div>
                <div className="text-xs text-green-600 mt-1">Excellent condition</div>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border border-emerald-200">
                <div className="text-2xl font-bold text-emerald-700">{Math.round(stats.farmHealthScore * 1.1)}%</div>
